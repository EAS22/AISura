    ...
    >
      ...
      >
        <div
          ...
          className='flex h-full w-full flex-col bg-sidebar group-data-[variant=floating]:rounded-2xl group-data-[variant=floating]:border group-data-[variant=floating]:border-white/60 group-data-[variant=floating]:bg-white/65 group-data-[variant=floating]:shadow-sm group-data-[variant=floating]:shadow-blue-100/30 group-data-[variant=floating]:backdrop-blur-xl group-data-[variant=floating]:supports-[backdrop-filter]:bg-white/55 dark:group-data-[variant=floating]:border-white/10 dark:group-data-[variant=floating]:bg-zinc-950/62 dark:group-data-[variant=floating]:supports-[backdrop-filter]:bg-zinc-950/52'
        >
          {children}
        </div>
      </div>
...
const sidebarMenuButtonVariants = cva(
  'peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-xl p-2 text-start text-sm outline-hidden ring-sidebar-ring transition-[width,height,padding,background,color,box-shadow] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-data-[sidebar=menu-action]/menu-item:pe-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-blue-600 data-[active=true]:font-semibold data-[active=true]:text-white data-[active=true]:shadow-sm data-[active=true]:shadow-blue-200 data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0 data-[active=true]:[&>svg]:text-white dark:data-[active=true]:shadow-none',
  {
    variants: {
      variant: {
